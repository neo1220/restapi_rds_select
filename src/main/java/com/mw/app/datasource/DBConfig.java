...
@EnableJpaRepositories(
        basePackages = "com.mw.app.repository", // TODO Repository 패키지 지정
...
public class DBConfig {
    ...
    @Primary
    @Bean(name = "mariaDB_dataSource")
    @ConfigurationProperties("spring.datasource.mariadb") // application.properties에서 설정한 DataSource명
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
            ...
            @Qualifier("mariaDB_dataSource") DataSource dataSource) {
        ...
        return builder.dataSource(dataSource)
                .packages("com.mw.app.domain") // TODO Model 패키지 지정
                .properties(map)
                .build();
    }
